...
namespace SXGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Ability_ID_Action_Combat_CheckHit_Grenade, "Ability.ID.Action.Combat.CheckHit.Grenade", "수류탄 피격 어빌리티를 식별 태그");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Ability_TYPE_Action_Combat_CheckHit_Grenade, "Ability.Type.Action.Combat.CheckHit.Grenade", "수류탄 피격 타입 태그");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Event_Action_Combat_Ranged_CheckHit_Grenade, "Event.Action.Combat.Ranged.CheckHit.Grenade", "수류탄 공격 히트 체크 이벤트 태그");
	
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(SetByCaller_Damage, "SetByCaller.Damage", "");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(SetByCaller_Damage_Grenade, "SetByCaller.Damage.Grenade", "");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(GameplayCue_Action_Combat_Explosion_Grenade, "GameplayCue.Action.Combat.Explosion.Grenade", "");
